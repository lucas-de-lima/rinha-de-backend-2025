...
// 	protoc        (unknown)
// source: signet-go/proto/v1/spec.proto
...
func (x *SignetPayload) Reset() {
	*x = SignetPayload{}
	mi := &file_signet_go_proto_v1_spec_proto_msgTypes[0]
...
func (*SignetPayload) Descriptor() ([]byte, []int) {
	return file_signet_go_proto_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SignetToken) Reset() {
	*x = SignetToken{}
	mi := &file_signet_go_proto_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignetToken) Descriptor() ([]byte, []int) {
	return file_signet_go_proto_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_signet_go_proto_v1_spec_proto protoreflect.FileDescriptor

const file_signet_go_proto_v1_spec_proto_rawDesc = "" +
	"\n" +
	"\x1dsignet-go/proto/v1/spec.proto\x12\tsignet.v1\"\xa3\x02\n" +
	...
	"\tsignature\x18\x02 \x01(\fR\tsignatureB\xbe\x01\n" +
	"\rcom.signet.v1B\tSpecProtoP\x01Z]github.com/lucas-de-lima/rinha-de-backend-2025/internal/gen/proto/signet-go/proto/v1;signetv1\xa2\x02\x03SXX\xaa\x02\tSignet.V1\xca\x02\tSignet\\V1\xe2\x02\x15Signet\\V1\\GPBMetadata\xea\x02\n" +
	"Signet::V1b\x06proto3"

var (
	file_signet_go_proto_v1_spec_proto_rawDescOnce sync.Once
	file_signet_go_proto_v1_spec_proto_rawDescData []byte
)

func file_signet_go_proto_v1_spec_proto_rawDescGZIP() []byte {
	file_signet_go_proto_v1_spec_proto_rawDescOnce.Do(func() {
		file_signet_go_proto_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_signet_go_proto_v1_spec_proto_rawDesc), len(file_signet_go_proto_v1_spec_proto_rawDesc)))
	})
	return file_signet_go_proto_v1_spec_proto_rawDescData
}

var file_signet_go_proto_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_signet_go_proto_v1_spec_proto_goTypes = []any{
...
var file_signet_go_proto_v1_spec_proto_depIdxs = []int32{
...
func init() { file_signet_go_proto_v1_spec_proto_init() }
func file_signet_go_proto_v1_spec_proto_init() {
	if File_signet_go_proto_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_signet_go_proto_v1_spec_proto_rawDesc), len(file_signet_go_proto_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_signet_go_proto_v1_spec_proto_goTypes,
		DependencyIndexes: file_signet_go_proto_v1_spec_proto_depIdxs,
		MessageInfos:      file_signet_go_proto_v1_spec_proto_msgTypes,
	}.Build()
	File_signet_go_proto_v1_spec_proto = out.File
	file_signet_go_proto_v1_spec_proto_goTypes = nil
	file_signet_go_proto_v1_spec_proto_depIdxs = nil
}
